...
RQ																			
	TEST NAME	REV-C_TETRA_RX-BBFILT	##This will be the Directory Name under C:\RageATE Results																
...
21	0	dBFS Reference Level	dB	-2	"Used to compute gain.Converts dBFS to dBm. Based on FS(ADC) = 2V, and ADC load of 98.3 ohms"														
