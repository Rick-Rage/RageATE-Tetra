...
RQ																			
	TEST NAME	REV-LC_TETRA_RX-BBFILT	##This will be the Directory Name under C:\RageATE Results																
...
5	0	"[fixed ,sweep] ; [IF_FREQ(mhz), REF FREQ(ghz)]"	MHz/GHZ	sweep; 30	##use neg (-) for LO<RF ; If sweep is selected then enter a freq in GHZ that will hold the REF freq so you can sweep the RF and look at IF response.														
...
7	-2	RF_FREQ	GHZ	30	30.075	0.0001													
