...
#START
        ...
        printLine(fp, comm, 'pmb 0x69 wr 0xff 10')
        printLine(fp, comm, 'pmb 0x69 wr 0x00 rd 9')  # 0x00-0x08
        printLine(fp, comm, 'pmb 0x69 wr 0x10 rd 16') # 0x10-0x1F
        printLine(fp, comm, 'pmb 0x69 wr 0x20 rd 16') # 0x20-0x2F
        printLine(fp, comm, 'pmb 0x69 wr 0x30 rd 8')  # 0x30-0x37
        printLine(fp, comm, 'pmb 0x69 wr 0xD0 rd 2')  # 0xD0-0xD1
        printLine(fp, comm, 'pmb 0x69 wr 0xff 11')
        printLine(fp, comm, 'pmb 0x69 wr 0x00 rd 9')  # 0x00-0x08
        printLine(fp, comm, 'pmb 0x69 wr 0x10 rd 16') # 0x10-0x1F
        printLine(fp, comm, 'pmb 0x69 wr 0x20 rd 16') # 0x20-0x2F
        printLine(fp, comm, 'pmb 0x69 wr 0x30 rd 8')  # 0x30-0x37
        printLine(fp, comm, 'pmb 0x69 wr 0xD0 rd 2')  # 0xD0-0xD1
        printLine(fp, comm, 'pmb 0x69 wr 0xff 12')
        printLine(fp, comm, 'pmb 0x69 wr 0x07 0xFF')  # Clear Sticky Bits
        printLine(fp, comm, 'pmb 0x69 wr 0x00 rd 9')  # 0x00-0x08
        printLine(fp, comm, 'pmb 0x69 wr 0x10 rd 16') # 0x10-0x1F
        printLine(fp, comm, 'pmb 0x69 wr 0x20 rd 16') # 0x20-0x2F
        printLine(fp, comm, 'pmb 0x69 wr 0x30 rd 8')  # 0x30-0x37
        printLine(fp, comm, 'pmb 0x69 wr 0xD0 rd 2')  # 0xD0-0xD1
        printLine(fp, comm, 'pmb 0x69 wr 0xff 13')
        printLine(fp, comm, 'pmb 0x69 wr 0x00 rd 9')  # 0x00-0x08
        printLine(fp, comm, 'pmb 0x69 wr 0x10 rd 16') # 0x10-0x1F
        printLine(fp, comm, 'pmb 0x69 wr 0x20 rd 16') # 0x20-0x2F
        printLine(fp, comm, 'pmb 0x69 wr 0x30 rd 8')  # 0x30-0x37
...
if __name__ == '__main__':
    ...
    main(comm, path)
    comm.close()
    if filecmp.cmp(path, "wamGood.txt"):
        print("PASS")
    else:
        print("FAIL")
