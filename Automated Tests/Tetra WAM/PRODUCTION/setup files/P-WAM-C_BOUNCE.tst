...
RQ																			
	TEST NAME	P-WAM-C_BOUNCE																	
	SN	P0030																	
																			
Index	Key	Vi Sequence	##KEY : 0 = DON’T RUN ;  1= RUN w/ FP open ; -1 = RUN w/ FP closed																
0	1	Setup vi Path	C:\RageATE\Automated Tests\Tetra WAM\PRODUCTION\prod test vis\Tetra_BOUNCE_Setup.vi																
1	-1	Payload vi Path	C:\RageATE\Automated Tests\Tetra WAM\PRODUCTION\prod test vis\Tetra_BOUNCE_Payload.vi																
2	1	Close vi Path	C:\RageATE\Automated Tests\Tetra WAM\PRODUCTION\prod test vis\Tetra_BOUNCE_Close.vi																
