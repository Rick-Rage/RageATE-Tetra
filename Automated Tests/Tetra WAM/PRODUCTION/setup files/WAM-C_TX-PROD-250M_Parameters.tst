...
RQ																			
	TEST NAME	REV-C_TETRA_TX-PROD-250M																	
	SN	P0030																	
...
6	0	Meas Plate Temp; Meas Chip Temp	Bool;Bool	0;0	"IF = 0, Then will measure temp on : 1) 1st Iteration And 2) Every time a port change occurs. IF = 1 will every iteration"														
...
5	1	ADAR_ATT	DB	-1															
6	1	PSA_ATT	DB	-1															
7	-2	RF_FREQ_OUT	GHZ	20	40	0.25													
