...
RQ																			
	TEST NAME	REV-C_TETRA_RX-PROD-250M	##This will be the Directory Name under C:\RageATE Results																
...
9	0	Meas Temp Sensors;Meas Temp Plate	Bool	0;0	"Meas Temp Sensors if ""1"" , will get all the on board Temp data ; Meas Temp Plate if ""1"" will measure the 2 temp sensors that are connected to the Temp Plate System"														
